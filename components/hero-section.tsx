          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            <div className="mb-8">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground mb-4">
                ...
                <span className="text-primary text-balance">Jopher Joe Ribo</span>
              </h1>
              ...
              <p className="text-lg text-muted-foreground max-w-2xl lg:max-w-none text-pretty">
                Constantly growing, I create web experiences that are clean, responsive, and user-centered.
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center mb-12">
              <Button size="lg" onClick={() => window.open("/resume.pdf", "_blank")} className="w-full sm:w-auto">
                Download Resume
              </Button>
