...
export const experienceItems: ExperienceItem[] = [
  {
    ...
    highlights: [
      ...
      "Participated in the designing and documentation of the Travel Mid Office System, with a focus on system scalability, long-term growth, and smoothknowledge transfer.",
      ...
      "Contributed to the development of a prototype checklist tool that helps farmers manage their agricultural operations based on selected areas from a farmmap.",
